    ...
    <div className="bg-black relative" id="portfolio">
      ...
      <div className="lg:flex text-white">
        <div className="w-full lg:w-[25%]">
          <div
            className="h-[350px] lg:h-[700px] group duration-700 cursor-pointer"
            style={{
              backgroundImage:
            ...
            data-aos="zoom-in"
          >
            <div className="h-[350px] lg:h-[700px] duration-700 hidden group-hover:flex justify-center flex-col items-center text-white group-hover:bg-[#000000b0]">
