...
const Pricing = () => {
  return (
    <div className="" id="pricing">
      ...
      <div className="w-[90%] mx-auto lg:w-[1080px] grid md:grid-cols-2 lg:grid-cols-3 gap-10 justify-center items-center py-20">
        <div
          data-aos="zoom-in"
          className="pl-10 lg:px-10 py-5 border-2 w-full border-gray-700"
        >
          <p>BASIC</p>
